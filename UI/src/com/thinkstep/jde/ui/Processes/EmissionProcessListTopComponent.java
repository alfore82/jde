 ...
 */
@ConvertAsProperties(
        dtd = "-//com.thinkstep.jde.ui.Processes//EmissionProcessList//EN",
        autostore = false
)
...
public final class EmissionProcessListTopComponent extends TopComponent {
    ...
    public EmissionProcessListTopComponent() {
        initComponents();
        setName(Bundle.CTL_EmissionProcessListTopComponent());
        setToolTipText(Bundle.HINT_EmissionProcessListTopComponent());
    ...
    private void createScene(){
        ...
        try {
            ...
            URL location = getClass().getResource("EmissionProcessList.fxml");
