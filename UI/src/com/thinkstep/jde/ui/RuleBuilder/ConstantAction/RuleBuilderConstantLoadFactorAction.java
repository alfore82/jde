 ...
 * @author forell
 */
public class RuleBuilderConstantLoadFactorAction implements RuleBuilderActionType, ConstantActionCallback{

    
    private ConstantActionController constantLoadFactorController;
    ...
    public Scene openMenu() {
        try {
            ...
            constantLoadFactorController = (ConstantActionController) fxmlLoader.getController();
            constantLoadFactorController.setRuleBulderConstantAction(this);
            constantLoadFactorController.setFieldNames(FieldName.LOADFACTORPICKUP, FieldName.LOADFACTORMAIN, FieldName.LOADFACTORDELIVERY,
                    FieldName.EMPTYTRIPFACTORPICKUP, FieldName.EMPTYTRIPFACTORMAIN, FieldName.EMPTYTRIPFACTORDELIVERY);
            if (this.constantAction != null){
                constantLoadFactorController.setAction(constantAction);
            }
    ...
    public static String getDisplayName() {
        return "Map constant load factor / empty trip factor";
    }
