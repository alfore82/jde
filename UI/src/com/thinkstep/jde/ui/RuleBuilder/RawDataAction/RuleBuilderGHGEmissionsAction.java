 ...
 * @author forell
 */
public class RuleBuilderGHGEmissionsAction implements RuleBuilderActionType, RuilBuilderRawDataValueActionCallback{
    ...
    public Scene openMenu() {
        try {
            ...
            ctrl.setFieldNames(FieldName.GHGEMISSIONSPICKUP, FieldName.GHGEMISSIONSMAIN, FieldName.DISTANCEDELIVERY);
    ...
    public static String getDisplayName() {
        return "Map ghg emissions on raw data";
    }
