 ...
 * @author forell
 */
public class RuleBuilderDistanceAction implements RuleBuilderActionType, RuilBuilderRawDataValueActionCallback{
    ...
    public Scene openMenu() {
        try {
            ...
            ctrl.setFieldNames(FieldName.DISTANCEPICKUP, FieldName.DISTANCEMAIN, FieldName.DISTANCEDELIVERY);
    ...
    public static String getDisplayName() {
        return "Map distance based on raw data";
    }
