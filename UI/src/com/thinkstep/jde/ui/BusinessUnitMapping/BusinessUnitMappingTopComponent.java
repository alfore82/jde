...
public final class BusinessUnitMappingTopComponent extends TopComponent {
    
    private static JFXPanel fxPanel;
    private LogisticServiceProvider lsp;

    public BusinessUnitMappingTopComponent() {
        initComponents();
    ...
    public BusinessUnitMappingTopComponent(LogisticServiceProvider lsp) {
        initComponents();
    ...
    private void createScene(){
            BusinessUnitMapper root = new BusinessUnitMapper(lsp);
    ...
    public boolean canClose(){
        BusinessUnitMapperService buService = BusinessUnitMapperService.getInstance();
        buService.removeComponent(this);
        return true;
