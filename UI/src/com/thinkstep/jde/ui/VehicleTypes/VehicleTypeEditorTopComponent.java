 ...
 */
@ConvertAsProperties(
        dtd = "-//com.thinkstep.jde.ui.countries//VehicleTypeEditor//EN",
        autostore = false
)
...
public final class VehicleTypeEditorTopComponent extends TopComponent {
    ...
    public VehicleTypeEditorTopComponent() {
        initComponents();
        setName(Bundle.CTL_VehicleTypeEditorTopComponent());
        setToolTipText(Bundle.HINT_VehicleTypeEditorTopComponent());
    ...
    private void createScene(){
        ...
        try {
            ...
            URL location = getClass().getResource("VehicleTypeEditor.fxml");
